...
for f in archivos:
	...
	for line in archivo:
		...
		if i == 13:
			...
			#Se agrega al diccionario el nombre promedio de la latitud y de la longitud y el área
			fuerzasPoliciacas.update({nombreFuerza : {"area": area, "latitud": promedioLatitud, "longitud": promedioLongitud}})
...
resultados = open("dataset-3.csv", "a") #Se abre el archivo

#Se asignan los resultados y se escriben en el archivo
for fuerza in fuerzasPoliciacas:
	fila = fuerza + "," + str(fuerzasPoliciacas[fuerza]["area"]) + "," + str(fuerzasPoliciacas[fuerza]["latitud"]) + "," + str(fuerzasPoliciacas[fuerza]["longitud"]) + "\n"
